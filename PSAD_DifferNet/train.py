...
from model import DifferNet, PSAD_earlyfusion_DifferNet, PSAD_latefusion_DifferNet, save_model, save_weights
from utils import *
...
def train(train_loader, test_loader):
    if 'single' in plus_variable.version:
        ...
        model = PSAD_earlyfusion_DifferNet()
    elif 'late' in plus_variable.version:
        model = PSAD_latefusion_DifferNet()
